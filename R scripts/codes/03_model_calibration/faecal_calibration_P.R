################################################################################
#
#                NIRS MODEL CALIBRATION FOR FAECAL P CONTENT
#
################################################################################
...
# the faecal phosphorus (P) content of herbivores in the Icelandic tundra. The models 
...
# - The final multispecies model is saved as "nirs_faecal_P_model2024.rda".
