################################################################################
#                     
#                      FAECAL C NIRS CALIBRATION MODEL
#                               
################################################################################
...
# faecal carbon content from herbivores in the Icelandic tundra
...
save(nirs_faecal_C_model2024, 
     file = "./code/a_ready_to_apply_nirs_model_nutrient/nirs_faecal_C_model2024.rda")  # save the model
